let startBtn = document.getElementById("start"),
  ...
  optlExpensesValue = document.getElementsByClassName(
...
optionalExpensesBtn.addEventListener("click", function () {
  for (let i = 0; i < optExpensesItem.length; i++) {
    ...
    optlExpensesValue.textContent += appData.optionalExpenses[i] + " ";
  }
});
...
countBtn.addEventListener("click", function () {
  if (appData.budget != undefined) {
    ...
    if (appData.moneyPerDay < 1000) {
      ...
      levelValue.textContent = "Произвошла какая то ошибка";
    }
  } else {
    dayBudgetValue.textContent = "Произошла какая то ошибка";
  }
});
